      ...
      <img
        ...
        <Left>
         ...
         <motion.div whileHover={{ scale:1.5 }}
            ><Link href="https://github.com/Henrich77/poor-4-lio/files/11325602/HENRICH.RESUME.4.pdf" target={"_blank"}  download={true}><Button> Resume <MdFileDownload style={{fontSize:"1.5rem"}}/></Button></Link></motion.div>
        </Left>
        <Right>

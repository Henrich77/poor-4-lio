      ...
      <VerticalTimeline animate={true} lineColor={"black"}>
        ...
        >
          ...
          <p style={{ fontSize: "1.3rem" }}>
            ...
            great weather ever since I opened my eyes. I am the oldest of 10
            children that my mother and father have together so don't be alarmed
            if I refer to myself as a father of 9.{" "}
          </p>
        </VerticalTimelineElement>
        <VerticalTimelineElement
          className="vertical-timeline-element--work"
        ...
        >
          ...
          <p style={{ fontSize: "1.2rem" }}>
            ...
            simple as resetting the WI-FI router. I always enjoyed the the
            challanges of learning something new and that makes the
            accomplishments and progress I have made much more satisfying.
          </p>
        </VerticalTimelineElement>
        <VerticalTimelineElement
          className="vertical-timeline-element--work"
        ...
        >
          ...
          <p style={{ fontSize: "1.3rem" }}>
            ...
            Accountant and learned business, taxes, and Real estate.
          </p>
        </VerticalTimelineElement>
        <VerticalTimelineElement
          className="vertical-timeline-element--work"
        ...
        >
          ...
          <p style={{ fontSize: "1.3rem" }}>
            ...
            on MERN stack. I graduated from the Bootcamp in March 2023.
          </p>
        </VerticalTimelineElement>
        <VerticalTimelineElement
          className="vertical-timeline-element--work"

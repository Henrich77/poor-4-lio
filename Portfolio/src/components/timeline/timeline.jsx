      ...
      <VerticalTimeline animate={true} lineColor={"black"}>
        ...
        >
          ...
          <p style={{fontSize:"1.3rem"}}>
            ...
            simple as resetting the WIFI router.I always enjoyed the
            the challanges of learning something new and that makes the 
             accomplishments and progress I 
            have made much sweeter.
          </p>
        </VerticalTimelineElement>
        <VerticalTimelineElement
          className="vertical-timeline-element--work"
        ...
        >
          ...
          <p style={{fontSize:"1.3rem"}}>
          I graduted highschool in 2018 from Miami Norland Senior High. After highschool I was not sure what path I wanted to take in life, I attended Broward Community College without a clear and set plan in mind. Several months later in the same year, I began to intern as an Accountant and learned Business, Taxes, and Real Estate. Now having acquired that knowledge I wanted to emabark on the journey of learning software development and that is when I decided to take the challenge of going through the UCF Coding Bootcamp which focused on MERN stack. I graduated from the Bootcamp in march 2023. 
    </p>
        </VerticalTimelineElement>
        <VerticalTimelineElement
          className="vertical-timeline-element--work"
        ...
        >
          ...
          <p  style={{fontSize:"1.3rem"}}>
          When I am not working you can catch me at the local gym exercising and playing basketball, I still believe that one of these days the Miami Heat will contact me to join their basketball team. I also love to eat so if you are a company running low on funds feel free to pay me in burgers.
    </p>
        </VerticalTimelineElement>
        <VerticalTimelineElement
          className="vertical-timeline-element--work"
        ...
        >
          ...
          <p  style={{fontSize:"1.3rem"}}>
          Thank you for taking the time to get to know a little more about me, I am excited to connect with you.
    </p>
        </VerticalTimelineElement>
      </VerticalTimeline>
    </div>
